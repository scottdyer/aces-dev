...
(
	...
	input varying float Y_MIN = 0.02,                       // black luminance (cd/m^2)
	input varying float Y_MID = 4.8,                        // mid-point luminance (cd/m^2)
	input varying float Y_MAX = 48.0,                       // peak white luminance (cd/m^2)

	input varying float SLOPE_MIN = 0.0,                    // min-point slope
	input varying float SLOPE_MID = 1.55,                   // mid-point slope
	input varying float SLOPE_MAX = 0.0,                    // max-point slope
...
*/
	input varying float PCT_LOW = 0.35,                     // the % between Y_MIN and Y_MID
	input varying float PCT_HIGH = 0.90                     // the % between Y_MID and Y_MAX
)
{
